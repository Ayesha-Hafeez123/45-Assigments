...
let names: string[] = ["Zara", "Zaiba", "Asiya", "Hina", "Shabnam", "Areeba", "Adeeba", "Dua"]

let message: string = "How Do You Do Dear?";
...
console.log(names [6] + " " + message)
console.log(names [7] + " " + message)
