...
class Shirt {
    ...
    constructor(size: string = "large", message: string = " I LOVE YOU MOM & DAD") {
        this.size = size;
...
function make_shirt(size: string = "medium", message: string = "I LOVE YOU MOM & DAD") {
...
const customShirt = make_shirt("small", "I am pakistani");
